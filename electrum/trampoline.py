...
TRAMPOLINE_NODES_MAINNET = {
    ...
    'Electrum trampoline':    LNPeerAddr(host='lightning.electrum-ltc.org',  port=9740, pubkey=bytes.fromhex('03ecef675be448b615e6176424070673ef8284e0fd19d8be062a6cb5b130a0a0d1')),
...
TRAMPOLINE_NODES_TESTNET = {
    ...
    'Electrum trampoline': LNPeerAddr(host='lightning.electrum-ltc.org', port=9739, pubkey=bytes.fromhex('02bf82e22f99dcd7ac1de4aad5152ce48f0694c46ec582567f379e0adbf81e2d0f')),
}
